...
export declare function readEntryManifest(): EntryManifest;
export declare function writeEntryManifest(manifest: EntryManifest): void;
export declare function updateEntryStatus(entryId: string, status: EntryStatus['status'], commitHash: string): void;
